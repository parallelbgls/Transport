...
#pragma warning disable
        ...
        public static Endian Parse(string value)
        {
            ...
            {
                if (assembly.GetType("Transport.Net.Endian")?.GetField(value) != null)
                {
                    return (int)assembly.GetType("Transport.Net.Endian").GetField(value).GetValue(null);
                }
            }
        ...
        public override string ToString()
        {
            ...
            foreach (var assembly in Assemblies)
            {
                var endianType = assembly.GetType("Transport.Net.Endian");
                if (endianType != null)
                {
