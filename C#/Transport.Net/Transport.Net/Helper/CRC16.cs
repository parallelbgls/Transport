/*
 * Crc16来自于多个网络上的代码，Transport.Net的作者不保留对Crc16类的版权。
 * Crc16 class comes from mutiple websites, the author of "Transport.Net" <b>donnot</b> obtain the copyright of Crc16(only).
 */
