...
using AddressUnit = Transport.Net.AddressUnit<string, int, int>;
using MachineJobSchedulerCreator = Transport.Net.MachineJobSchedulerCreator<Transport.Net.IMachineMethodDatas, string, double>;
using ModbusMachine = Transport.Net.Modbus.ModbusMachine<string, string>;
