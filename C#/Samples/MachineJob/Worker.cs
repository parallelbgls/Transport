using Transport.Net;
using DataReturnDef = Transport.Net.DataReturnDef<string, double>;
using MultipleMachinesJobScheduler = Transport.Net.MultipleMachinesJobScheduler<Transport.Net.IMachineMethodDatas, string, double>;
